...
class GetHomeSectionResponse with _$GetHomeSectionResponse {
  factory GetHomeSectionResponse({
    ...
    @JsonKey(name: 'collectionsContent') List<CollectionResponse>? collectionsContent,
  }) = _GetHomeSectionResponse;

  factory GetHomeSectionResponse.fromJson(Map<String, dynamic> json) => _$GetHomeSectionResponseFromJson(json);
}
