...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  HomeBloc() : super(_Initial()) {
    ...
    on<_HomeEventLoadSectionMovies>((event, emit) async {
      emit(HomeState.loaded(
          channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.loadingMovies));
      try {
        ...
        emit(HomeState.loaded(
            channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.loadedMovies));
      } catch (e) {
        emit(HomeState.loaded(channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.error));
      }
    });
    on<_HomeEventLoadSectionSeries>((event, emit) async {
      emit(HomeState.loaded(
          channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.loadingSeries));
      try {
        ...
        emit(HomeState.loaded(
            channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.loadedSeries));
      } catch (e) {
        emit(HomeState.loaded(channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.error));
      }
    });
    on<_HomeEventLoadSectionAnimes>((event, emit) async {
      emit(HomeState.loaded(
          channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.loadingAnimes));
      try {
        ...
        emit(HomeState.loaded(
            channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.loadedAnimes));
      } catch (e) {
        emit(HomeState.loaded(channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.error));
      }
    });
    on<_HomeEventLoadSectionDramas>((event, emit) async {
      emit(HomeState.loaded(
          channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.loadingDramas));
      try {
        ...
        emit(HomeState.loaded(
            channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.loadedDramas));
      } catch (e) {
        emit(HomeState.loaded(channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.error));
      }
    });
    on<_HomeEventLoadSectionKids>((event, emit) async {
      emit(HomeState.loaded(
          channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.loadingKids));
      try {
        if (kidsSection == null) {
        ...
        emit(HomeState.loaded(
            channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.loadedKids));
      } catch (e) {
        emit(HomeState.loaded(channels: selectedChannel, movies: moviesSection, series: seriesSection, animes: animesSection, dramas: dramasSection, kids: kidsSection, status: HomeStateStatus.error));
      }
    });
