...
void main() async {
  ...
  FlutterError.onError = (FlutterErrorDetails details) async {
    ...
    await saveLog('FlutterError: ${details.exceptionAsString()}');
    await saveLog('StackTrace: ${details.stack}');
  };
  ...
  runZonedGuarded(() async {
    ...
    await saveLog('Zoned error: $error');
    await saveLog('StackTrace: $stack');
  });
}
