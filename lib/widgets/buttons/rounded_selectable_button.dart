...
Widget roundedSelectableButton(BuildContext context, Function press,
    String textButton, Color colorBorder, bool isActive,
  ...
  return ElevatedButton(
    ...
    style: ButtonStyle(
        ...
        backgroundColor:
            WidgetStateProperty.all<Color>(isActive ? colorBorder : inactive)),
