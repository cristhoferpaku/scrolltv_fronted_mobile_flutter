...
class PlatformUtils {
  ...
  static bool get isTV {
    ...
    const appName =
        String.fromEnvironment('FLUTTER_APP_NAME', defaultValue: '');
  ...
  static Map<String, String> get debugInfo {
    return {
      ...
      'FLUTTER_FLAVOR': const String.fromEnvironment('FLUTTER_FLAVOR',
          defaultValue: 'not_set'),
      'FLUTTER_APP_NAME': const String.fromEnvironment('FLUTTER_APP_NAME',
          defaultValue: 'not_set'),
